...
function do_build() {
	...
	cmake -S . -B "$build_dir" -S . -DCMAKE_BUILD_TYPE=Release -G Ninja -DCMAKE_C_COMPILER_LAUNCHER=ccache  -DCMAKE_CXX_COMPILER_LAUNCHER=ccache -DMANUAL_SUBMODULES=1  || fail "$banner - cmake failed"
